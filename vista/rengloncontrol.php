...
<html>
    ...
    <body>        
        ...
        <table>
            <tr>
                ...
                <td>
                    <a href="index.php?controller=renglonControl&action=existencia&idOrden=<?php echo $idOrden ?>">Nuevo Renglon</a>                    
                </td>                               
            </tr>
        </table>                
    ...
    foreach($ordenBus->listRenglonesControl as $listRenglones):
...
<?php endforeach; ?>
        ...
        <br>
        <td><a href="index.php?controller=renglonAjuste&action=mostrar&idOrden=<?php echo $idOrden; ?>">Siguiente-></td>
    </body>
</html>
