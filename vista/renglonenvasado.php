...
<html>
    ...
    <body>        
        ...
        <table>
            <tr>
                ...
                <td>
                    <a href="index.php?controller=renglonEnvasado&action=existencia&idOrden=<?php echo $idOrden ?>">Nuevo Renglon</a>                    
                </td>                               
            </tr>
        </table>                
    ...
    foreach($ordenBus->listRenglonesEnvasado as $listRenglones):
...
?>
    <tr>                
        ...
        <td><a href="index.php?controller=renglonEnvasado&action=existencia&id=<?php echo $listRenglones->id; ?>&idOrden=<?php echo $_REQUEST['idOrden']?>">Editar</a></td>
        ...
        <?php if($listRenglones->fin == '00:00:00'): ?>
            <td><a onclick="javascript:return confirm('Seguro que quiere finalizar el Renglon?');" href="index.php?controller=renglonEnvasado&action=finalizarRenglon&id= <?php echo $listRenglones->id; ?>&idOrden=<?php echo $_REQUEST['idOrden']?>">Finalizar</a></td>
        <?php endif; ?>
    </tr>
<?php endforeach; ?>
        </table>
